package com.kadirgurturk.TodoRestAPI.error;
...
public class ErrorHandler implements ErrorController {
    ...
    public Response handleError(WebRequest webRequest) {
        ...
        response = new Response(status, path, message);
        ...
        if (attributes.containsKey("errors")) {
            ...
            response.setValidationErrors(validationMistake);
        }
        return response;
